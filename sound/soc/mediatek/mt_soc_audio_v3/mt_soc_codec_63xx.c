...
#if 1  // #ifdef CONFIG_MTK_SPEAKER  // tongjun Add for audio.useExternAmp
...
static int useExternAmp = 0;   // tongjun Add for audio.useExternAmp
...
static void Apply_Speaker_Gain(void)
{
	...
	if(!useExternAmp){  // tongjun Add for audio.useExternAmp @{
...
if(!useExternAmp){  // tongjun Add for audio.useExternAmp @{ #ifdef CONFIG_MTK_SPEAKER
...
if(useExternAmp){  // tongjun Add for audio.useExternAmp @{ #ifndef CONFIG_MTK_SPEAKER
#if defined(CONFIG_MTK_LEGACY)
		...
		AudDrv_GPIO_SPKSD_Select(false);//mid_czy add for ausw /spk pa
		AudDrv_GPIO_AUSW_Select(true);//mid_czy add for ausw /spk pa
		...
		AudDrv_GPIO_SPKSD_Select(true);//mid_czy add for ausw /spk pa
		AudDrv_GPIO_AUSW_Select(false);//mid_czy add for ausw /spk pa
#endif /*CONFIG_MTK_LEGACY*/
...
{
	pr_warn("%s:\n", __func__);
	useExternAmp = (item_integer("audio.useExternAmp", 0 )==1)?1:0;  // tongjun Add for audio.useExternAmp
#ifndef CONFIG_OF
	int ret = 0;
