...
/*	data_array[0]= 0x10b21500;  //2 channel
	...
	data_array[0]= 0x70851500;	//0x5a871500;
	dsi_set_cmdq(data_array, 1, 1);
	
	data_array[0]= 0x70861500;	//0x5a871500;
	dsi_set_cmdq(data_array, 1, 1);
...
LCM_DRIVER lf705_ypd_ek79007_ivo_wsvga_7_lcm_drv = 
{
  .name				= "lf705_ypd_ek79007_ivo_wsvga_7",
