...
static void lcm_get_params(LCM_PARAMS *params)
{
   ...
   // params->dsi.intermediat_buffer_num = 0;
    ...
    //params->dsi.word_count=FRAME_WIDTH*3;
		...
		params->dsi.PLL_CLOCK 	=280;//210;// 220;//245 by eric.wang
...
data_array[0]= 0x00033902; //by eric.wang
data_array[1]= 0x000030be;
//data_array[1]=temp[index%14];
//index++;
dsi_set_cmdq(data_array, 2, 1);
...
//zengzonghui 2015.10.13
data_array[0]= 0x00023902;
data_array[1]= 0x0000166F;
dsi_set_cmdq(data_array, 2, 1);

//zengzonghui 2015.10.13
data_array[0]= 0x00023902;
data_array[1]= 0x000010F7;
dsi_set_cmdq(data_array, 2, 1);
...
LCM_DRIVER sl101pc27y0877_a00_nt35521_wxga_lcm_drv = 
{
  .name				= "SL101PC27Y0877_A00_NT35521_WXGA",
