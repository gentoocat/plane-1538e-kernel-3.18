...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.vertical_frontporch = 30;//8; //16; //15;
	params->dsi.vertical_active_line = FRAME_HEIGHT;

	params->dsi.horizontal_sync_active = 18;//8; //4; //4;
	params->dsi.horizontal_backporch =	18; //8; //4; //42;  //50;
	params->dsi.horizontal_frontporch = 18;//40; //105; //16; //44; //60;
...
LCM_DRIVER lf705_dy_hx8394_wxga_ips_lcm_drv = 
{
	.name = "lf705_dy_hx8394_wxga_ips",
