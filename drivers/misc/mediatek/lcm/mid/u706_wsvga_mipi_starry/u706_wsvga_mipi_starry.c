...
/*	data_array[0]= 0x10b21500;  //2 channel
	...
	data_array[0]= 0x88801500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0]= 0x78811500;
	dsi_set_cmdq(data_array, 1, 1);
	
	data_array[0]= 0x84821500;
	dsi_set_cmdq(data_array, 1, 1);
	
	data_array[0]= 0x88831500;
	dsi_set_cmdq(data_array, 1, 1);
	
	data_array[0]= 0xA8841500;
	dsi_set_cmdq(data_array, 1, 1);	

	data_array[0]= 0x83851500;	//0x5a871500;
	dsi_set_cmdq(data_array, 1, 1);
	
	data_array[0]= 0x86861500;	//0x5a871500;
	dsi_set_cmdq(data_array, 1, 1);
...
LCM_DRIVER u706_wsvga_mipi_starry_lcm_drv = 
{
  .name				= "u706_wsvga_mipi_starry",
