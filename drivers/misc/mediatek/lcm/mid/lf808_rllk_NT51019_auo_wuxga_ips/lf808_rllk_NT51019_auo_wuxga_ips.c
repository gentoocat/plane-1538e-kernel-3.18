...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    params->dsi.horizontal_sync_active				= 8;//0;
    params->dsi.horizontal_backporch				= 60;//160;
    params->dsi.horizontal_frontporch				= 60; //100;//160;
    params->dsi.horizontal_active_pixel 			= FRAME_WIDTH;

    params->dsi.PLL_CLOCK = 480;//148;
}
...
static void init_lcm_registers(void)
{
	...
	MDELAY(50);
	/*
	data_array[0] = 0x019D1500;
	dsi_set_cmdq(data_array, 1, 1);
	
	data_array[0] = 0x011D1500;
	dsi_set_cmdq(data_array, 1, 1);
	
	data_array[0] = 0xA9F01500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x8FFD1500;
	dsi_set_cmdq(data_array, 1, 1);
	*/
...
LCM_DRIVER lf808_rllk_NT51019_auo_wuxga_ips_lcm_drv = 
{
	.name = "lf808_rllk_NT51019_auo_wuxga_ips",
