...
void mt_usb_set_vbus(struct musb *musb, int is_on)
{
	...
	if(!strcmp(CONFIG_BUILD_ARM64_APPENDED_DTB_IMAGE_NAMES,"mt8735_6ttb_n_LF156")){ //Neil add
		
		//DBG(0, "Neil  156 ..........,is_on=%d\r\n", is_on);
		mt_set_gpio_mode(GPIO68, GPIO_MODE_00);
		mt_set_gpio_dir(GPIO68, GPIO_DIR_OUT);
		mt_set_gpio_out((GPIO68 | 0x80000000), GPIO_OUT_ONE);
		//mt_set_gpio_mode(GPIO124, GPIO_MODE_00);
		//mt_set_gpio_dir(GPIO124, GPIO_DIR_OUT);
		//mt_set_gpio_out((GPIO124 | 0x80000000), GPIO_OUT_ONE);
		...
		//Neil add
		if(!strcmp(CONFIG_BUILD_ARM64_APPENDED_DTB_IMAGE_NAMES,"mt8735_6ttb_n_LF156")){  
			mt_set_gpio_out((GPIO68 | 0x80000000), GPIO_OUT_ZERO);
			//mt_set_gpio_out((GPIO124 | 0x80000000), GPIO_OUT_ZERO);
		} 
		else{
...
#ifndef FPGA_PLATFORM
#if defined(CONFIG_MTK_DUAL_INPUT_CHARGER_SUPPORT)		
		pmic_chrdet_int_en(1); //by eric.wang
#endif
#endif
