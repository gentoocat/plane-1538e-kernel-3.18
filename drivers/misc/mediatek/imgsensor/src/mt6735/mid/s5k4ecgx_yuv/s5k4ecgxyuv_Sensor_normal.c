...
/*             0x0028, 0x7000,
    ...
    //==================================================================================
        ...
        // AWB init Start point
             ...
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0650); //awbb_GainsInit_0_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0400); //awbb_GainsInit_1_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0680); //awbb_GainsInit_2_
...
S5K4ECGX_write_cmos_sensor(0x0F12, 0xA060);//70000A28//AFIT8_ee_iLowSharpPower[7:0]AFIT8_ee_iHighSharpPower
...
S5K4ECGX_write_cmos_sensor(0x0F12, 0xc080);//70000ADE//AFIT8_ee_iLowSharpPower[7:0]AFIT8_ee_iHighSharpPower
...
S5K4ECGX_write_cmos_sensor(0x0F12, 0xc080);//70000B94//AFIT8_ee_iLowSharpPower[7:0]AFIT8_ee_iHighSharpPower
...
S5K4ECGX_write_cmos_sensor(0x0F12, 0xc080);//70000C4A//AFIT8_ee_iLowSharpPower[7:0]AFIT8_ee_iHighSharpPower
...
S5K4ECGX_write_cmos_sensor(0x0F12, 0xc080);//70000D00//AFIT8_ee_iLowSharpPower[7:0]AFIT8_ee_iHighSharpPower
