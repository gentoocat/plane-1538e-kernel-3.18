...
S5K4ECGX_AF_Init(void)
{
    ...
    if (S5K4ECGX_AF_STATE_UNINIT == S5K4ECGX_Driver.afState)
    {
        ...
        backupAFWindDone = 0;
        printk("\n [S5K4ECGX_AF_Init] S5K4ECGX_AF_STATE_UNINIT == S5K4ECGX_Driver.afState. \n");
    }
    ...
    if (!backupAFWindDone)
    {
        ...
        S5K4ECGX_AF_WIN_T  *AfWindows;
		printk("\n [S5K4ECGX_AF_Init] backupAFWindDone = 0. \n");
        spin_lock(&s5k4ecgx_drv_lock);
        AfWindows = &S5K4ECGX_Driver.orignalAfWindows;
        spin_unlock(&s5k4ecgx_drv_lock);
...
S5K4ECGX_AF_Set_Window(  
    uintptr_t zone_addr,//by eric.wang
    unsigned int prevW,
    unsigned int prevH)
{
    ...
    unsigned int srcW_maxH,frameTime;
...
void S5K4ECGX_get_exposure_gain(void)
{
...
0x0F12, 0x080C, //[7:0]hold_st, [15:8]hold_width
    ...
    //==================================================================================
   {
    ...
    //==================================================================================
        ...
        // AWB init Start point
             0x002A, 0x145E,
             0x0F12, 0x0650, //awbb_GainsInit_0_
             0x0F12, 0x0400, //awbb_GainsInit_1_
             0x0F12, 0x0680, //awbb_GainsInit_2_
    ...
    //==================================================================================
   {
    ...
    //==================================================================================
        //AE Target
             0x002A, 0x1484,
             0x0F12, 0x0038,   //TVAR_ae_BrAve  //0x38
...
//==================================================================================
    ...
    //==================================================================================
0x002A, 0x0944,
0x0F12, 0x0080, //afit_uNoiseIndInDoor  0x0050
...
0x002A, 0x0938,
0x0F12, 0x0000,//on/offAFITbyNBoption
...
0x0F12, 0x0000,//70000A46//AFIT16_SATURATION 0x0015
...
0x0F12, 0xC080,//70000ADE//AFIT8_ee_iLowSharpPower[7:0]AFIT8_ee_iHighSharpPower   0x6024
...
0x0F12, 0x0000,//70000AFC//AFIT16_SATURATION  0x0015
...
0x0F12, 0x0000,//70000BB2//AFIT16_SATURATION 0x0015
...
0x0F12, 0x0430, //70000C06//AFIT8_ee_iWSharpen [7:0] AFIT8_ee_iMShThresh  0x044E
...
0x0F12, 0x0000,//70000C68//AFIT16_SATURATION  0x0015
...
0x0F12, 0x0438, //70000CBC//AFIT8_ee_iWSharpen [7:0] AFIT8_ee_iMShThresh  0x0450
...
//#endif 
    ...
    //For MCLK=24MHz, PCLK=5DC0
             ...
             0x002A, 0x0212,
             0x0F12, 0x0002,   //0x212:REG_TC_IPRM_UseNPviClocks
             0x0F12, 0x0000,   //0x214:REG_TC_IPRM_UseNMipiClocks
             0x0F12, 0x0000,   //0x216:REG_TC_IPRM_NumberOfMipiLanes

             0x002A, 0x021A,
             0x0F12, CLK0_SYS_OP_RATE,  //0x4F1A//0x3A98//0x32c8);
             0x0F12, CLK0_MAX, //REG_TC_IPRM_MinOutRate4KHz_0 PCLK Min : 81Mhz
             0x0F12, CLK0_MIN, //REG_TC_IPRM_MaxOutRate4KHz_0 PCLK Max : 81Mhz

             0x0F12, CLK1_SYS_OP_RATE,  //0x32c8//0x4F1A;
             0x0F12, CLK1_MIN, //REG_TC_IPRM_MinOutRate4KHz_1 PCLK Min : 81Mhz
             0x0F12, CLK1_MAX, //REG_TC_IPRM_MaxOutRate4KHz_1 PCLK Max : 81Mhz
    ...
    //91MHz, 1280x960, Dynamic mode 30~7.5fps
             ...
             0x0F12, CLK0_MAX,  //REG_0TC_PCFG_usMaxOut4KHzRate PCLK Min : xxMhz
             0x0F12, CLK0_MIN,  //REG_0TC_PCFG_usMinOut4KHzRate PCLK Max : xxMhz
             ...
             0x0F12, 0x0535, //REG_0TC_PCFG_usMaxFrTimeMsecMult10 //0x0535
...
/*     S5K4ECGX_PreviewWin[0].GrabStartX = 0;
...

   {
       static  kal_uint16 addr_data_pair[] =
       {
             ...
             0x0F12, CLK0_MAX,  //REG_1TC_PCFG_usMaxOut4KHzRate PCLK Min : xxMhz
             0x0F12, CLK0_MIN,  //REG_1TC_PCFG_usMinOut4KHzRate PCLK Max : xxMhz
...

   {
       static  kal_uint16 addr_data_pair[] =
       {
        //config[2]:
             ...
             0x0F12, CLK0_MAX,  //REG_2TC_PCFG_usMaxOut4KHzRate PCLK Min : xxMhz
             0x0F12, CLK0_MIN,  //REG_2TC_PCFG_usMinOut4KHzRate PCLK Max : xxMhz
...
/*     S5K4ECGX_PreviewWin[2].GrabStartX = 0;
...

   {
       static  kal_uint16 addr_data_pair[]=
       {
             ...
             0x0F12, CLK1_MAX,  //REG_0TC_CCFG_usMaxOut4KHzRate PCLK Min : xxMhz
             0x0F12, CLK1_MIN,  //REG_0TC_CCFG_usMinOut4KHzRate PCLK Max : xxMhz
             ...
             0x0F12, CAP_CLK_IDX,   //REG_0TC_CCFG_uClockInd
...
UINT32 S5K4ECGX_GetSensorID(UINT32 *sensorID)
{
   ...
   do {
        ...
        *sensorID = S5K4ECGX_read_cmos_sensor(0x0F12);
        ...
        {
            printk("lyq [4EC]ID = 0x%04x\n", *sensorID);
            break;
        }
        printk("lyq [4EC]Read Sensor ID Fail = 0x%04x\n", *sensorID);
        retry--;
   } while (retry > 0);
...
void S5K4ECGX_SceneOffMode(void)
{
    ...
    MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
  ...
  /*          S5K4ECGX_AE_Set_Window((unsigned int)S5K4ECGX_Driver.apAEWindows,
                                       (unsigned int)S5K4ECGX_IMAGE_SENSOR_PV_WIDTH_DRV,
                                       (unsigned int)S5K4ECGX_IMAGE_SENSOR_PV_HEIGHT_DRV); */
       }
    }
    else
    {
    ...
    MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
        ...
        (height == S5K4ECGX_IMAGE_SENSOR_FULL_HEIGHT_DRV))
    {
        //Reset AE table due to Preview Size Changed
  /*       S5K4ECGX_AE_Set_Window((unsigned int)S5K4ECGX_Driver.apAEWindows,
                                    (unsigned int)S5K4ECGX_IMAGE_SENSOR_FULL_WIDTH_DRV,
                                    (unsigned int)S5K4ECGX_IMAGE_SENSOR_FULL_HEIGHT_DRV); */
    }
...
void S5K4ECGX_set_saturation(UINT16 para)
{
    ...
    S5K4ECGX_write_cmos_sensor(0x0F12 ,0x0010);  //REG_TC_UserSaturation
    S5K4ECGX_write_cmos_sensor(0x0F12 ,0x0050);  //REG_TC_UserSaturation	
/*    switch (para)
    {
        case ISP_SAT_HIGH:
...
//void S5K4ECGX_GetDelayInfo(UINT32 delayAddr) //by eric.wang
void S5K4ECGX_GetDelayInfo(uintptr_t delayAddr)
{
...
//    MSDK_SENSOR_ENG_INFO_STRUCT *pSensorEngInfo=(MSDK_SENSOR_ENG_INFO_STRUCT *) pFeaturePara;
    ...
    switch (FeatureId)
    {
        ...
        case SENSOR_FEATURE_GET_EV_AWB_REF:
             ...
             S5K4ECGX_GetEvAwbRef((PSENSOR_AE_AWB_REF_STRUCT)*pFeatureData64);
             break;

        case SENSOR_FEATURE_GET_SHUTTER_GAIN_AWB_GAIN:
             SENSORDB("[4EC] F_GET_SHUTTER_GAIN_AWB_GAIN\n");
             S5K4ECGX_GetCurAeAwbInfo((PSENSOR_AE_AWB_CUR_STRUCT)*pFeatureData64);
             break;
        ...
        case SENSOR_FEATURE_GET_DELAY_INFO:
             ...
             //S5K4ECGX_GetDelayInfo(*pFeatureData64);//eric.wang
             S5K4ECGX_GetDelayInfo((uintptr_t)*pFeatureData64);
             break;
        ...
        case SENSOR_FEATURE_MOVE_FOCUS_LENS:
             ...
             //S5K4ECGX_AF_Move_to((unsigned int)pFeatureReturnPara32); // not implement yet. by eric.wang
        ...
        case SENSOR_FEATURE_SET_AF_WINDOW:
             ...
             //S5K4ECGX_AF_Set_Window(*pFeatureReturnPara32, S5K4ECGX_Driver.Preview_Width, S5K4ECGX_Driver.Preview_Height); //by eric.wang             
             S5K4ECGX_AF_Set_Window((uintptr_t)*pFeatureData64, S5K4ECGX_Driver.Preview_Width, S5K4ECGX_Driver.Preview_Height);            
             break;

        case SENSOR_FEATURE_SET_AE_WINDOW:
             SENSORDB("[4EC] F_SET_AE_WINDOW\n");
             S5K4ECGX_AE_Set_Window((unsigned int)(*pFeatureReturnPara32), (unsigned int)S5K4ECGX_Driver.Preview_Width, (unsigned int)S5K4ECGX_Driver.Preview_Height);
             break;

        case SENSOR_FEATURE_GET_AE_AWB_LOCK_INFO:
             SENSORDB("[4EC] F_GET_AE_AWB_LOCK_INFO\n");
             S5K4ECGX_get_AEAWB_lock((UINT32 *)(*pFeatureData64),(UINT32 *)*(pFeatureData64+1));
             break;
