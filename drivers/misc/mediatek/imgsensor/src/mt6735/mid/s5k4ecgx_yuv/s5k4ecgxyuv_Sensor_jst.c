...
static void S5K4ECGX_Init_Setting(void)
{
    ...
    S5K4ECGX_write_cmos_sensor(0x0F12, 0x05a5); //cregs_clks_output_cd10 //SDA[11:10], SCL[9:8], PCLK[7:6], VSYNC[3:2], HSYNC[1:0]
    ...
    MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    ...
    spin_lock(&s5k4ecgx_drv_lock);
    pSensorInfo->CaptureDelayFrame = 0;    //(0 == S5K4ECGX_Driver.manualAEStart) ? 3 : 2;
    spin_unlock(&s5k4ecgx_drv_lock);
