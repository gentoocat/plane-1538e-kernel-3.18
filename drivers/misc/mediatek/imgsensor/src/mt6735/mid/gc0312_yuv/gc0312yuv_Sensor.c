...
void GC0312_Sensor_Init(void)
{
	...
	///////////////////   DNDD  /////////////////////
	///////////////////////////////////////////////// 
	GC0312_write_cmos_sensor(0x82, 0x14);//14 
	GC0312_write_cmos_sensor(0x83, 0x0b);//0b
	...
	GC0312_write_cmos_sensor(0x95, 0x33);//65
...
*/
	...
	GC0312_write_cmos_sensor(0xd1, 0x32);//34 
	GC0312_write_cmos_sensor(0xd2, 0x32);//34 
	GC0312_write_cmos_sensor(0xd3, 0x46);//40 
	GC0312_write_cmos_sensor(0xd5, 0xf0); 
	...
	GC0312_write_cmos_sensor(0x13, 0x3b);//38 
...
UINT32 GC0312GetSensorID(UINT32 *sensorID)
{
    ...
    do {
        *sensorID=((GC0312_read_cmos_sensor(0xf0)<< 8)|GC0312_read_cmos_sensor(0xf1));
		...
		printk("GC0312GetSensorID=%x,by eric.wang\n",*sensorID);
    if (*sensorID != GC0312_SENSOR_ID) {
        *sensorID = 0xFFFFFFFF; 
...
BOOL GC0312_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_10:			
			GC0312_write_cmos_sensor(0xfe, 0x01);
			GC0312_write_cmos_sensor(0x13, 0x43);
			GC0312_write_cmos_sensor(0xfe, 0x00);
		break;
