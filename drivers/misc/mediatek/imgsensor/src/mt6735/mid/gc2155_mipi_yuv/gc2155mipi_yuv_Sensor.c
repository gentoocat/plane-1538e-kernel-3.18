...
#define GC2155_TEST_PATTERN_CHECKSUM (0x310ff422)//cyrille add liuhanhui
...
#define POSTGAIN_THRESHOLD 0x20
#define PREGAIN_THRESHOLD 0x20 
...
//static kal_uint16 GC2155MIPI_exposure_lines=0;
...
static void GC2155MIPI_Sensor_Init(void)
{
	...
	GC2155MIPI_write_cmos_sensor(0x97 , 0x18);//////0x44
	GC2155MIPI_write_cmos_sensor(0x98 , 0x88);
	GC2155MIPI_write_cmos_sensor(0x9d , 0x05);
	...
	GC2155MIPI_write_cmos_sensor(0x82 , 0x05);///0x05
	GC2155MIPI_write_cmos_sensor(0x83 , 0x10);////0x04
	GC2155MIPI_write_cmos_sensor(0x84 , 0x0a);
	GC2155MIPI_write_cmos_sensor(0x86 , 0x80);
	GC2155MIPI_write_cmos_sensor(0x87 , 0x30);
	GC2155MIPI_write_cmos_sensor(0x88 , 0x15);/////0x15
	...
	/////////////////////////////////////////////// 
	GC2155MIPI_write_cmos_sensor(0xfe , 0x02);
	GC2155MIPI_write_cmos_sensor(0xd1 , 0x30);
	...
	GC2155MIPI_write_cmos_sensor(0xc1 , 0x46);// 4e
	...
	GC2155MIPI_write_cmos_sensor(0xc7 , 0x30);//45
	...
	GC2155MIPI_write_cmos_sensor(0x27 , 0x0b); 
	GC2155MIPI_write_cmos_sensor(0x28 , 0xb8); //20fps 
	GC2155MIPI_write_cmos_sensor(0x29 , 0x0b); 
	GC2155MIPI_write_cmos_sensor(0x2a , 0xb8); //16fps 
	GC2155MIPI_write_cmos_sensor(0x2b , 0x0b); 
	GC2155MIPI_write_cmos_sensor(0x2c , 0xb8); //16fps
	GC2155MIPI_write_cmos_sensor(0x2d , 0x0d); 
	GC2155MIPI_write_cmos_sensor(0x2e , 0xac); //8fps
	/*	
	GC2155MIPI_write_cmos_sensor(0xfe , 0x00);
	GC2155MIPI_write_cmos_sensor(0x05 , 0x02);
	GC2155MIPI_write_cmos_sensor(0x06 , 0xd3);
	GC2155MIPI_write_cmos_sensor(0x07 , 0x00);
	GC2155MIPI_write_cmos_sensor(0x08 , 0x72);
	GC2155MIPI_write_cmos_sensor(0xfe , 0x01);
	GC2155MIPI_write_cmos_sensor(0x25 , 0x00);
	GC2155MIPI_write_cmos_sensor(0x26 , 0xbe); 
	GC2155MIPI_write_cmos_sensor(0x27 , 0x08); 
	GC2155MIPI_write_cmos_sensor(0x28 , 0xe8); //20fps 
	GC2155MIPI_write_cmos_sensor(0x29 , 0x08); 
	GC2155MIPI_write_cmos_sensor(0x2a , 0xe8); //16fps 
	GC2155MIPI_write_cmos_sensor(0x2b , 0x08); 
	GC2155MIPI_write_cmos_sensor(0x2c , 0xe8); //16fps
...
*/
 ...
 UINT32  GC2155MIPI_GetSensorID(UINT32 *sensorID)

{
	...
	sensor_id=((GC2155MIPI_read_cmos_sensor(0xf0) << 8) | GC2155MIPI_read_cmos_sensor(0xf1));	
	 	printk("GC2155SUBMIPI Sensor id = %x\n", sensor_id);
	...
	if (sensor_id!= GC2155MIPI_SENSOR_ID)
	 {
	 SENSORDB("GC2155SUBMIPI Sensor id read failed, ID = %x\n", sensor_id);		
...
UINT32 GC2155MIPIOpen(void)
{
	...
	{
		sensor_id=((GC2155MIPI_read_cmos_sensor(0xf0) << 8) | GC2155MIPI_read_cmos_sensor(0xf1));   
		SENSORDB("liuhanhui GC2155MIPI_Open, sensor_id:%x \n",sensor_id);
		if (sensor_id != GC2155MIPI_SENSOR_ID)
		return ERROR_SENSOR_CONNECT_FAIL;
	}
...
BOOL GC2155MIPI_set_param_banding(UINT16 para)
{
    switch (para)
    {
		...
		GC2155MIPI_write_cmos_sensor(0x2a , 0xb8); //16fps 
		GC2155MIPI_write_cmos_sensor(0x2b , 0x0b); 
		GC2155MIPI_write_cmos_sensor(0x2c , 0xb8); //14fps 
		GC2155MIPI_write_cmos_sensor(0x2d , 0x0d); 
		GC2155MIPI_write_cmos_sensor(0x2e , 0xac); //8fps
		GC2155MIPI_write_cmos_sensor(0xfe , 0x00);
            break;
		...
		GC2155MIPI_write_cmos_sensor(0x27 , 0x0b); 
		GC2155MIPI_write_cmos_sensor(0x28 , 0x60); //20fps 
		GC2155MIPI_write_cmos_sensor(0x29 , 0x0b); 
		GC2155MIPI_write_cmos_sensor(0x2a , 0x60); //16fps 
		GC2155MIPI_write_cmos_sensor(0x2b , 0x0b); 
		GC2155MIPI_write_cmos_sensor(0x2c , 0x60); //14fps 
		GC2155MIPI_write_cmos_sensor(0x2d , 0x0d); 
		GC2155MIPI_write_cmos_sensor(0x2e , 0x00); //8fps
		GC2155MIPI_write_cmos_sensor(0xfe , 0x00);
            break;
...
// cyrille add for liuhanhui
UINT32 GC2155MIPIYUVSetTestPatternMode(kal_bool bEnable)
{
    SENSORDB("[GC2155MIPIYUVSetTestPatternMode] Test pattern enable:%d\n", bEnable);
    if(bEnable)
    {
        GC2155MIPI_write_cmos_sensor(0xfe,0x00); //2235"S bit[4]: 1 enable test pattern, 0 disable test pattern
		GC2155MIPI_write_cmos_sensor(0x80,0x08);//only intpenable
		GC2155MIPI_write_cmos_sensor(0x81,0x00);//close all
		GC2155MIPI_write_cmos_sensor(0x82,0x00);//close all
		GC2155MIPI_write_cmos_sensor(0xb6,0x00);//AEC en
		GC2155MIPI_write_cmos_sensor(0x18,0x06);//sdark
		GC2155MIPI_write_cmos_sensor(0xb3,0x40);//AWB gain
        GC2155MIPI_write_cmos_sensor(0xb4,0x40);//AWB gain
		GC2155MIPI_write_cmos_sensor(0xb5,0x40);//AWB gain
		GC2155MIPI_write_cmos_sensor(0xfe,0x02); //2235'S bit[4]: 1 enable test pattern, 0 disable test pattern
	    GC2155MIPI_write_cmos_sensor(0xd0,0x40);//Global saturation
		GC2155MIPI_write_cmos_sensor(0xdd,0x00);//edge_sa
		GC2155MIPI_write_cmos_sensor(0xfe,0x00);
		GC2155MIPI_write_cmos_sensor(0xb1,0x40);//Auto_pregain
		GC2155MIPI_write_cmos_sensor(0xb2,0x40);//Auto_pregain
		GC2155MIPI_write_cmos_sensor(0x03,0x00);//Exposure
		GC2155MIPI_write_cmos_sensor(0x04,0x00);
		GC2155MIPI_write_cmos_sensor(0x8c,0x01);//test pattern VGA// 91 for UXGA
	...
	{
	    GC2155MIPI_write_cmos_sensor(0x8c,0x00);//2235'S bit[0]: 1 enable test pattern, 0 disable test pattern
	}
    return ERROR_NONE;
}

//cyrille add for liuhanhui end

///////////////////
static void GC2155_MIPI_FlashTriggerCheck(unsigned int *pFeatureReturnPara32)
{
    unsigned int pregain;
    unsigned int postgain;
   
    GC2155MIPI_write_cmos_sensor(0xfe,0x00);
    pregain = GC2155MIPI_read_cmos_sensor(0xb1);
    postgain = GC2155MIPI_read_cmos_sensor(0xb2);
	//printk("pregain:%d\n", pregain); 
	//printk("postgain:%d\n", postgain); 
    if ((pregain > PREGAIN_THRESHOLD)&&(pregain > POSTGAIN_THRESHOLD))
    {
       *pFeatureReturnPara32 = FALSE;
	   //printk("FALSE at 1687 \n");
        return;
    }	
							 ...
							 UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	switch (FeatureId)
	{
	       ...
	       case SENSOR_FEATURE_GET_TRIGGER_FLASHLIGHT_INFO:
              GC2155_MIPI_FlashTriggerCheck(pFeatureData32);
			  //printk("[GC2155] F_GET_TRIGGER_FLASHLIGHT_INFO: %d\n", pFeatureData32);
 ...
 // cyrille add for liuhanhui
		case SENSOR_FEATURE_SET_TEST_PATTERN:
			GC2155MIPIYUVSetTestPatternMode((BOOL) *pFeatureData16);
			break;
