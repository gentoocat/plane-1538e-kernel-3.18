...

{
	...
	*sensorID=((GC2145_read_cmos_sensor(0xf0) << 8) | GC2145_read_cmos_sensor(0xf1));	
	...
	printk("GC2145GetSensorID=%x,by eric.wang\n",*sensorID);
	if (*sensorID != GC2145_SENSOR_ID) {		
		*sensorID = 0xFFFFFFFF;		
...
static void GC2145_Sensor_Init(void)
{
	...
	SENSORDB("GC2145_Sensor_Init");
 	...
 	GC2145_write_cmos_sensor(0xf8 , 0x84);//84
	...
	GC2145_write_cmos_sensor(0x24 , 0x3f);//16
	...
	GC2145_write_cmos_sensor(0x97 , 0x54);
	...
	GC2145_write_cmos_sensor(0x82 , 0x15);//1F
	GC2145_write_cmos_sensor(0x83 , 0x2a);
	...
	GC2145_write_cmos_sensor(0xfe , 0x01);
	GC2145_write_cmos_sensor(0xa1 , 0x7b);
	GC2145_write_cmos_sensor(0xa2 , 0x74);
	GC2145_write_cmos_sensor(0xa4 , 0x77);
	GC2145_write_cmos_sensor(0xa5 , 0x77);
	GC2145_write_cmos_sensor(0xa6 , 0x77);
	GC2145_write_cmos_sensor(0xa7 , 0x77);
	GC2145_write_cmos_sensor(0xa8 , 0x00);
	GC2145_write_cmos_sensor(0xa9 , 0x70);
	GC2145_write_cmos_sensor(0xaa , 0x15);
	GC2145_write_cmos_sensor(0xab , 0x19);
	GC2145_write_cmos_sensor(0xac , 0x19);
	GC2145_write_cmos_sensor(0xad , 0x0f);
	GC2145_write_cmos_sensor(0xae , 0x1d);
	GC2145_write_cmos_sensor(0xaf , 0x05);
	GC2145_write_cmos_sensor(0xb0 , 0x14);
	GC2145_write_cmos_sensor(0xb1 , 0x30);
	GC2145_write_cmos_sensor(0xb2 , 0x39);
	GC2145_write_cmos_sensor(0xb3 , 0x23);
	GC2145_write_cmos_sensor(0xb4 , 0x2d);
	GC2145_write_cmos_sensor(0xb5 , 0x2b);
	GC2145_write_cmos_sensor(0xb6 , 0x4b);
	GC2145_write_cmos_sensor(0xb7 , 0x47);
	GC2145_write_cmos_sensor(0xb8 , 0x42);
	GC2145_write_cmos_sensor(0xb9 , 0x10);
	GC2145_write_cmos_sensor(0xba , 0x15);
	GC2145_write_cmos_sensor(0xbb , 0x0f);
	GC2145_write_cmos_sensor(0xbc , 0x50);
	GC2145_write_cmos_sensor(0xbd , 0x4f);
	GC2145_write_cmos_sensor(0xbe , 0x44);
	GC2145_write_cmos_sensor(0xbf , 0x1b);
	GC2145_write_cmos_sensor(0xc0 , 0x2a);
	GC2145_write_cmos_sensor(0xc1 , 0x1b);
	GC2145_write_cmos_sensor(0xc2 , 0x2f);
	GC2145_write_cmos_sensor(0xc3 , 0x29);
	GC2145_write_cmos_sensor(0xc4 , 0x31);
	GC2145_write_cmos_sensor(0xc5 , 0x0e);
	GC2145_write_cmos_sensor(0xc6 , 0x03);
	GC2145_write_cmos_sensor(0xc7 , 0x1c);
	GC2145_write_cmos_sensor(0xc8 , 0x34);
	GC2145_write_cmos_sensor(0xc9 , 0x2f);
	GC2145_write_cmos_sensor(0xca , 0x2b);
	GC2145_write_cmos_sensor(0xcb , 0x27);
	GC2145_write_cmos_sensor(0xcc , 0x1d);
	GC2145_write_cmos_sensor(0xcd , 0x28);
	GC2145_write_cmos_sensor(0xd0 , 0x10);
	GC2145_write_cmos_sensor(0xd1 , 0x0f);
	GC2145_write_cmos_sensor(0xd2 , 0x0a);
	GC2145_write_cmos_sensor(0xd3 , 0x50);
	GC2145_write_cmos_sensor(0xd4 , 0x50);
	GC2145_write_cmos_sensor(0xd5 , 0x50);
	GC2145_write_cmos_sensor(0xd6 , 0x2c);
	GC2145_write_cmos_sensor(0xd7 , 0x01);
	GC2145_write_cmos_sensor(0xd8 , 0x28);
	GC2145_write_cmos_sensor(0xd9 , 0x0e);
	GC2145_write_cmos_sensor(0xda , 0x3b);
	GC2145_write_cmos_sensor(0xdb , 0x50);
	...
	GC2145_write_cmos_sensor(0x28 , 0xd6); //20fps  4e2    14
	GC2145_write_cmos_sensor(0x29 , 0x07); 
	GC2145_write_cmos_sensor(0x2a , 0xd0); //14fps  6d6    12
	GC2145_write_cmos_sensor(0x2b , 0x09); 
	GC2145_write_cmos_sensor(0x2c , 0xc4); //12fps   7d0   10
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	pSensorInfo->CaptureDelayFrame = 0; //4
	pSensorInfo->PreviewDelayFrame = 0; //2
...
BOOL GC2145_set_param_banding(UINT16 para)
{
    switch (para)
    {
		...
		GC2145_write_cmos_sensor(0x2b , 0x09); 
		GC2145_write_cmos_sensor(0x2c , 0xc4); //12fps 
		GC2145_write_cmos_sensor(0x2d , 0x0b); 
		GC2145_write_cmos_sensor(0x2e , 0xb8); //8fps
		GC2145_write_cmos_sensor(0xfe , 0x00);
            break;
		...
		GC2145_write_cmos_sensor(0x2a , 0xe0); //14fps 
		GC2145_write_cmos_sensor(0x2b , 0x04); 
		GC2145_write_cmos_sensor(0x2c , 0xe0); //12fps 
		GC2145_write_cmos_sensor(0x2d , 0x04); 
		GC2145_write_cmos_sensor(0x2e , 0xe0); //8fps
		GC2145_write_cmos_sensor(0xfe , 0x00);
            break;
...
static UINT32 GC2145SetTestPatternMode(kal_bool bEnable)
{
