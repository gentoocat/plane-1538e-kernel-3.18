...
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = HM5040_MIPI_RAW_SENSOR_ID,		//record sensor id defined in Kd_imgsensor.h
...
static void sensor_init(void)
{
    ...
    write_cmos_sensor(0xFBD7,0x4C); //2 1  // FF_SUB_G1 HI
    write_cmos_sensor(0xFBD8,0x89); //2 1  // FF_SUB_G1 LO
    write_cmos_sensor(0xFBD9,0x44); //2 1  // FF_DIV_G1 HI
    write_cmos_sensor(0xFBDA,0xED); //2 1  // FF_DIV_G1 LO
    write_cmos_sensor(0xFBDB,0x4C); //2 1  // FF_SUB_G2 HI
    write_cmos_sensor(0xFBDC,0x6C); //2 1  // FF_SUB_G2 LO
    write_cmos_sensor(0xFBDD,0x44); //2 1  // FF_DIV_G2 HI
    write_cmos_sensor(0xFBDE,0xDA); //2 1  // FF_DIV_G2 LO
    write_cmos_sensor(0xFBDF,0x4C); //2 1  // FF_SUB_G4 HI
    write_cmos_sensor(0xFBE0,0x5F); //2 1  // FF_SUB_G4 LO
    write_cmos_sensor(0xFBE1,0x44); //2 1  // FF_DIV_G4 HI
    write_cmos_sensor(0xFBE2,0xE0); //2 1  // FF_DIV_G4 LO
    write_cmos_sensor(0xFBE3,0x4C); //2 1  // FF_SUB_G8 HI
    write_cmos_sensor(0xFBE4,0x59); //2 1  // FF_SUB_G8 LO
    write_cmos_sensor(0xFBE5,0x44); //2 1  // FF_DIV_G8 HI
    write_cmos_sensor(0xFBE6,0xE1); //2 1  // FF_DIV_G8 LO
    write_cmos_sensor(0xFBE7,0x4C); //2 1  // FF_SUB_G16 HI
    write_cmos_sensor(0xFBE8,0x4F); //2 1  // FF_SUB_G16 LO
    write_cmos_sensor(0xFBE9,0x44); //2 1  // FF_DIV_G16 HI
    write_cmos_sensor(0xFBEA,0xE6); //2 1  // FF_DIV_G16 LO
...
//checked below
    ...
    //write_cmos_sensor(0x0601,0x02);//TEST PATTERN
